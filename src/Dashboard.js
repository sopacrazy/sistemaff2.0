...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F3F4F6] dark:bg-[#0B1120] pb-20 font-sans transition-colors duration-300">
      ...
      <AppHeader title="Dashboard" subtitle="Visão Geral" icon="bar_chart" iconGradient="from-amber-500 to-orange-400" iconShadow="shadow-amber-500/20" onBack="/faturamento" />
